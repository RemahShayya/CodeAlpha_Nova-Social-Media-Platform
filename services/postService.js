...
export const getPostById = async (requesterId, postId) => {
  ...
  // Same "404 instead of 403" pattern used throughout — a blocked
  // relationship hides the post's existence entirely rather than
  // revealing it with an access-denied response.
