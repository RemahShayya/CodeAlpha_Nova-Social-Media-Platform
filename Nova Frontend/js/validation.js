/* Nova — client-side form validation */

const isValidEmail = (email) => /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email);

// Show/clear inline error under a .form-group
...
/* Validators return true when valid, and mark the field otherwise. */
...
/* Character counter binding: <textarea data-max="500"> + .char-counter */
...
/* Password visibility toggle: wraps .password-wrap > input + .password-toggle */
